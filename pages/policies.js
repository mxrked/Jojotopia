...
import Top from "../components/views/policies/Top";
import Main from "../components/views/policies/Main";
...
export default function Policies() {
  return (
    <div id={styles.mainBody}>
      <Head>
        <title>JojoTopia | A Bizarre Store (Policies)</title>
        ...
        <meta
          property="og:url"
          content="http://basicallyeasy.com/next-projects/jojotopia/policies/"
        />
        */}
        <meta name="robots" content="index, follow" />
